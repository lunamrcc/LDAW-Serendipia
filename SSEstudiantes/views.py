...
from Estudiantes.forms import EstudiantesForm
...
def student_lists(request):
    ...
    return render(request, 'SSEstudiantes/student_list.html',context)
...
def student_create(request):
    ...
    return render(request, 'SSEstudiantes/student_form.html', context)
...
class student_update(UpdateView):
    ...
    template_name = 'SSEstudiantes/student_edit_form.html'

    success_url = reverse_lazy('SSEstudiantes:student_lists')

def student_delete(request, pk):
    student = Estudiantes.objects.filter(pk=pk)
    student.delete()
    return HttpResponseRedirect(reverse('SSEstudiantes:student_lists'))
